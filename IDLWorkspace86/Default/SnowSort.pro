...
NotSnowy=fltarr(12,6794,2223)
  ...
  for i= 0,6794-1 do begin
    ...
    for j = 0,2223-1  do begin
      ...
      if Allsnow[k,i,j] ge 0.75 then Snowy[k,i,j]=testalb[k,i,j] else Snowy[k,i,j]= 9999
      if Allsnow[k,i,j] ge 0 and Allsnow[k,i,j] lt 0.75 then NotSnowy[k,i,j] = testalb[k,i,j] else NotSnowy[k,i,j]=9999
